...
<nav class="navbar navbar-expand-md navbar-dark navbar-fixed-top" id="ii">
   ...
   <div class="collapse navbar-collapse" id="new">
	...
	<li class="nav-item"><a class="nav-link active" href="#"><span class="glyphicon glyphicon-question-sign"></span>   Queries</a></li>
...
<h4 style="color:red">WELCOME TO USER QUERY SECTION</h4>
<p style="color:black;font-size:20px">Post your queries and your solution to queries asked by other users</p>
<div class="jumbotron">
<?php
...
{   
	echo "<h3>" . $row["u_name"] .":".'<scope style="color:orange;font-size:18px;">'."   (at  ".date("d/m/y h:i A",strtotime($row["time"])+(5*60*60)+(30*60)).")". '</scope>'."</h3>";
	echo "<p style='font-size:18px'>" . $row["ques"] . "<p><hr/>";
}

?></div>
</br><form action="query_ins.php" method="post">
...
<input type="text" name="uques" class="form-control" placeholder="Post your doubts and solutions" required></input></div></div>
